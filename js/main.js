...
let Shoppies = {
  ...
  getTrailers: (num)=>{
    fetch(Shoppies.proxy+`https://youtube-search-and-download.p.rapidapi.com/search?query=${Shoppies.youtubeNames[num].split(" ").join("%20")}%20Trailer&type=v&duration=s&sort=r`, {
      "method": "GET",
      "mode": 'cors',
    "headers": {
